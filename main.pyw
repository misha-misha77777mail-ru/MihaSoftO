...
def about_ms():
    def create_about_ms():
        ...
        info_string_2 = Label(m.info_window, text='Версия:   14.2.1')
...
if __name__ == '__main__':
    ...
    if os.path.exists('C:/MihaSoft Files') and os.path.exists('C:/MihaSoft Files/AnimationFlagFile.miha'):
        ...
        hello_title = Label(root, text='MihaSoft\n14.2.1', bg='red', fg='white', font=('Arial Bold', 60), height=100)
