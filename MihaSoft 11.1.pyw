...
def SML():
                        ...
                        if sml_code_input.get('4.0', '4.7') != 'const2=':
                            ...
                            if sml_code_input.get('5.0', '5.7') != 'method=':
                                ...
                                if sml_code_input.get('6.0', '6.4') != 'end;':
                                    ...
                                    sml_run_arg_1 = Label(sml.run_window, text=sml_arg_1)
                                    sml_run_arg_1.place(x=10, y=30)

                                    sml_run_arg_2 = Label(sml.run_window, text=sml.flag)
                                    sml_run_arg_2.place(x=30, y=30)

                                    sml_run_arg_3 = Label(sml.run_window, text=sml_arg_2)
                                    sml_run_arg_3.place(x=50, y=30)

                                    sml_label = Label(sml.run_window, text='=')
    ...
    root.title('The Simplest Mihail’s Language - IDE & Compiler')
...
def HolidayWarnings():
    ...
    window.configure(width=410, height=200)
    root.title('HolidayWarnings 1.0')
    ...
    def yw_preview():
        ...
        def yw_create_pa_window():
            def yw_open_preview():
                ...
                center_window(yw.preview_window, 480, 400)
                yw.preview_window.title(yw_preview_combobox.get())

                yw_preview_message = Label(yw.preview_window, text=yw_message[2], font=('Times New Roman', 20),
                                           fg='red')
...
def Saper():
    ...
    def s_bug(res_color):
        if s.glob_but['background'] != 'white':
            s.glob_but.configure(bg='white')
            for i in [s_box_a1, s_box_a2, s_box_a3, s_box_a4, s_box_a5, s_box_b1, s_box_b2, s_box_b3, s_box_b4,
                      s_box_b5, s_box_c1, s_box_c2, s_box_c3, s_box_c4, s_box_c5, s_box_d1, s_box_d2, s_box_d3,
                      s_box_d4, s_box_d5, s_box_e1, s_box_e2, s_box_e3, s_box_e4, s_box_e5]:
                print(i['background'], i['text'])
                if i != s.glob_but:
                    i.configure(text='')
                if i['background'] == 'white' and i != s.glob_but:
                    i.configure(bg=res_color)
                    break
    ...
    def s_to():
        s.flag_a1 = s.flags_array[0]
        s.flag_a2 = s.flags_array[1]
        s.flag_a3 = s.flags_array[2]
        s.flag_a4 = s.flags_array[3]
        s.flag_a5 = s.flags_array[4]
        s.flag_b1 = s.flags_array[5]
        s.flag_b2 = s.flags_array[6]
        s.flag_b3 = s.flags_array[7]
        s.flag_b4 = s.flags_array[8]
        s.flag_b5 = s.flags_array[9]
        s.flag_c1 = s.flags_array[10]
        s.flag_c2 = s.flags_array[11]
        s.flag_c3 = s.flags_array[12]
        s.flag_c4 = s.flags_array[13]
        s.flag_c5 = s.flags_array[14]
        s.flag_d1 = s.flags_array[15]
        s.flag_d2 = s.flags_array[16]
        s.flag_d3 = s.flags_array[17]
        s.flag_d4 = s.flags_array[18]
        s.flag_d5 = s.flags_array[19]
        s.flag_e1 = s.flags_array[20]
        s.flag_e2 = s.flags_array[21]
        s.flag_e3 = s.flags_array[22]
        s.flag_e4 = s.flags_array[23]
        s.flag_e5 = s.flags_array[24]

    def type_1(num, box, this_flag, flag_1, flag_2, flag_3):
        def s_open_box_1():
            k = 0
        ...
        if s.global_flag:
            if not this_flag:
                ...
                if s.start_flag:
                    ...
                    s.start_flag = False
                    this_flag = False
                    s.flags_array[num] = False
                    for i in range(len(s.flags_array)):
                        if not s.flags_array[i]:
                            s.flags_array[i] = True
                            break
                    s_to()
                    s.box_list = [s_box_a1, s_box_a2, s_box_a3, s_box_a4, s_box_a5, s_box_b1, s_box_b2, s_box_b3,
                                  s_box_b4,
                                  s_box_b5, s_box_c1, s_box_c2, s_box_c3, s_box_c4, s_box_c5, s_box_d1, s_box_d2,
                                  s_box_d3,
                                  s_box_d4, s_box_d5, s_box_e1, s_box_e2, s_box_e3, s_box_e4, s_box_e5]
                    s_box_list = [s_box_a1, s_box_a2, s_box_a3, s_box_a4, s_box_a5, s_box_b1, s_box_b2, s_box_b3,
                                  s_box_b4,
                                  s_box_b5, s_box_c1, s_box_c2, s_box_c3, s_box_c4, s_box_c5, s_box_d1, s_box_d2,
                                  s_box_d3,
                                  s_box_d4, s_box_d5, s_box_e1, s_box_e2, s_box_e3, s_box_e4, s_box_e5]
                    ...
                    for i in range(len(s.flags_array)):
                        if s.flags_array[i]:
                            s.box_list.remove(s_box_list[i])
                            s.bomb_list.append(s_box_list[i])
                    s_open_box_1()
                else:
                    GameOver()
        return this_flag
    ...
    def on_a1():
        type_1(0, s_box_a1, s.flag_a1, s.flag_a2, s.flag_b2, s.flag_b1)

    def on_a5():
        type_1(4, s_box_a5, s.flag_a5, s.flag_a4, s.flag_b4, s.flag_b5)

    def on_e1():
        type_1(20, s_box_e1, s.flag_e1, s.flag_d1, s.flag_d2, s.flag_e2)

    def on_e5():
        type_1(24, s_box_e5, s.flag_e5, s.flag_e4, s.flag_d4, s.flag_d5)

    def type_2(num, box, this_flag, flag_1, flag_2, flag_3, flag_4, flag_5):
        def s_open_box_2():
            k = 0
    ...
    def on_a2():
        type_2(1, s_box_a2, s.flag_a2, s.flag_a1, s.flag_b1, s.flag_b2, s.flag_b3, s.flag_a3)

    def on_a3():
        type_2(2, s_box_a3, s.flag_a3, s.flag_a2, s.flag_b2, s.flag_b3, s.flag_b4, s.flag_a4)

    def on_a4():
        type_2(3, s_box_a4, s.flag_a4, s.flag_a3, s.flag_b3, s.flag_b4, s.flag_b5, s.flag_a5)

    def on_b1():
        type_2(5, s_box_b1, s.flag_b1, s.flag_a1, s.flag_a2, s.flag_b2, s.flag_c2, s.flag_c1)

    def on_c1():
        type_2(10, s_box_c1, s.flag_c1, s.flag_b1, s.flag_b2, s.flag_c2, s.flag_d2, s.flag_d1)

    def on_d1():
        type_2(15, s_box_d1, s.flag_d1, s.flag_c1, s.flag_c2, s.flag_d2, s.flag_e2, s.flag_e1)

    def on_e2():
        type_2(21, s_box_e2, s.flag_e2, s.flag_e1, s.flag_d1, s.flag_d2, s.flag_d3, s.flag_e3)

    def on_e3():
        type_2(22, s_box_e3, s.flag_e3, s.flag_e2, s.flag_d2, s.flag_d3, s.flag_d4, s.flag_e4)

    def on_e4():
        type_2(23, s_box_e4, s.flag_e4, s.flag_e3, s.flag_d3, s.flag_d4, s.flag_d5, s.flag_e5)

    def on_b5():
        type_2(9, s_box_b5, s.flag_b5, s.flag_a5, s.flag_a4, s.flag_b4, s.flag_c4, s.flag_c5)

    def on_c5():
        type_2(14, s_box_c5, s.flag_c5, s.flag_b5, s.flag_b4, s.flag_c4, s.flag_d4, s.flag_d5)

    def on_d5():
        type_2(19, s_box_d5, s.flag_d5, s.flag_c5, s.flag_c4, s.flag_d4, s.flag_e4, s.flag_e5)

    def type_3(num, box, this_flag, flag_1, flag_2, flag_3, flag_4, flag_5, flag_6, flag_7, flag_8):
        def s_open_box_3():
            k = 0
    ...
    def on_b2():
        type_3(6, s_box_b2, s.flag_b2, s.flag_a1, s.flag_a2, s.flag_a3, s.flag_b3, s.flag_c3, s.flag_c2, s.flag_c1,
               s.flag_b1)

    def on_b3():
        type_3(7, s_box_b3, s.flag_b3, s.flag_a2, s.flag_a3, s.flag_a4, s.flag_b4, s.flag_c4, s.flag_c3, s.flag_c2,
               s.flag_b2)

    def on_b4():
        type_3(8, s_box_b4, s.flag_b4, s.flag_a3, s.flag_a4, s.flag_a5, s.flag_b5, s.flag_c5, s.flag_c4, s.flag_c3,
               s.flag_b3)

    def on_c2():
        type_3(11, s_box_c2, s.flag_c2, s.flag_b1, s.flag_b2, s.flag_b3, s.flag_c3, s.flag_d3, s.flag_d2, s.flag_d1,
               s.flag_c1)

    def on_c3():
        type_3(12, s_box_c3, s.flag_c3, s.flag_b2, s.flag_b3, s.flag_b4, s.flag_c4, s.flag_d4, s.flag_d3, s.flag_d2,
               s.flag_c2)

    def on_c4():
        type_3(13, s_box_c4, s.flag_c4, s.flag_b3, s.flag_b4, s.flag_b5, s.flag_c5, s.flag_d5, s.flag_d4, s.flag_d3,
               s.flag_c3)

    def on_d2():
        type_3(16, s_box_d2, s.flag_d2, s.flag_c1, s.flag_c2, s.flag_c3, s.flag_d3, s.flag_e3, s.flag_e2, s.flag_e1,
               s.flag_d1)

    def on_d3():
        type_3(17, s_box_d3, s.flag_d3, s.flag_c2, s.flag_c3, s.flag_c4, s.flag_d4, s.flag_e4, s.flag_e3, s.flag_e2,
               s.flag_d2)

    def on_d4():
        type_3(18, s_box_d4, s.flag_d4, s.flag_c3, s.flag_c4, s.flag_c5, s.flag_d5, s.flag_e5, s.flag_e4, s.flag_e3,
               s.flag_d3)
...
def TurtlePaint():
    def tp_help():
        ...
        def tp_create_help_window():
            ...
            center_window(tp.help_window, 460, 190)
            ...
            paint_help_label.place(x=5, y=5)
    ...
    window.configure(width=400, height=100)
...
def about_ms():
    ...
    info_string_2 = Label(info_window, text='Версия:   11.1')
...
def home():
    ...
    ms_mn_button = Button(window, text='MihNote', font=('Arial Bold', 13), width=25, height=2, bg='#FFFFFF',
                          command=home_to_mn)
    ms_mn_button.place(x=420, y=520)
    ...
    ms_hw_button = Button(window, text='HolidayWarnings', font=('Arial Bold', 13), width=25, height=2, bg='#93e6a1',
                          command=home_to_hw)
    ms_hw_button.place(x=420, y=460)
    ...
    ms_tp_button = Button(window, text='TurtlePaint', font=('Arial Bold', 13), width=25, height=2, bg='#9ae3de',
                          command=home_to_tp)
    ms_tp_button.place(x=420, y=640)
