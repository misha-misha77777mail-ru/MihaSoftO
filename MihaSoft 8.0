...
def fallout10():
    ...
    window2 = Tk()
    window2.geometry('600x600+50+50')
    window2.title('Shmalyalka 1.0')

    lbl1 = Label(window2, text="Shmalyalka 1.0", font=("Arial Bold", 16), fg="red")
    lbl1.place(x=40, y=20)
