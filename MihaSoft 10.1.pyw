        ...
        def openv():
            ...
            if a != []:
                ...
                if d != []:
                    ...
                    mn_close_button = Button(win4, text='Отмена', font=("Arial Bold", 12), bg='#b8b8b8', width=13, command=CloseEdit)
                    mn_close_button.place(x=290, y=5)
...
def fallout11():
    ...
    lastik = Button(window3, text='Ластик', bg='white', command=Lastik)
    lastik.place(x=315, y=10)
