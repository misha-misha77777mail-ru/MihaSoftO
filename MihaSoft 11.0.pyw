...
def YourAgeOnline():
    ...
    def yao_Save():
        ...
        yao_save_button = Button(yao_save_window, text='Сохранить', width=10, height=1, bg="#8ceb8a",
                                 command=yao_Save_OK)
...
def MiddleScoreOnline():
    ...
    def mso_Done():
        if not mso_input_1.get().isdigit() or (not mso_input_2.get().isdigit() and mso_input_2.get() != ''):
            ...
            for i in range(len(mso_score_list_1)):
                if (mso_score_list_1[i] != 2) and (mso_score_list_1[i] != 3) and (mso_score_list_1[i] != 4) and (mso_score_list_1[i] != 5):
            ...
            for i in range(len(mso_score_list_2)):
                if (mso_score_list_2[i] != 2) and (mso_score_list_2[i] != 3) and (mso_score_list_2[i] != 4) and (mso_score_list_2[i] != 5) and (mso_score_list_2[i] != 0):
            ...
            if mso_flag != 0:
                mso_z = (sum(mso_score_list_2) * 2 + sum(mso_score_list_1)) / (len(mso_score_list_1) + len(mso_score_list_2) * 2)
                mso_label_4.configure(text=mso_z)
                if (mso_z >= 3.6) and (mso_z <= 4.6):
                    mso_label_5.configure(text=('Можете расслабиться!!!'))
                    while (sum(mso_score_list_2) * 2 + sum(mso_score_list_1)) / (len(mso_score_list_1) + len(mso_score_list_2) * 2) < 4.6:
                        mso_score_list_1.append(5)
                        mso_j += 1
                    if mso_j == 1:
                        mso_label_6.configure(text=('У вас выходит четвёрка. Вам нужно получить ещё'))
                ...
                if (mso_z >= 2.6) and (mso_z < 3.6):
                    mso_label_5.configure(text=('Внимание!!!'))
                    while (sum(mso_score_list_2) * 2 + sum(mso_score_list_1)) / (len(mso_score_list_1) + len(mso_score_list_2) * 2) < 3.6:
                        mso_score_list_1.append(5)
                        mso_j += 1
                    if mso_j == 1:
                        mso_label_6.configure(text=('У вас выходит тройка. Вам нужно получить ещё'))
                ...
                if (mso_z >= 2) and (mso_z < 2.6):
                    mso_label_5.configure(text=('Вам трындец!!!!'))
                    while (sum(mso_score_list_2) * 2 + sum(mso_score_list_1)) / (len(mso_score_list_1) + len(mso_score_list_2) * 2) < 2.6:
                        mso_score_list_1.append(5)
                        mso_j += 1
                    if mso_j == 1:
                        mso_label_6.configure(text=('У вас выходит ДВОЙКА. Вам нужно получить ещё'))
    ...
    mso_off = Button(window, text='⌂', font=('Arial Bold', 15), width=2, height=1, bg='black', fg='white', command=mso_to_home)
    mso_off.place(x=0, y=0)
...
def SML():
    ...
    def sml_Help():
        def sml_Help_Example():
            ...
            sml_example_window.geometry('200x100+50+50')
            sml_example_window.resizable(0, 0)
        ...
        sml_help_window.geometry('1200x500+50+50')
        sml_help_window.resizable(0, 0)

        sml_help_field = Text(sml_help_window, width=145, height=25, font=('Times New Roman', 12))
    ...
    def sml_Begin():
        ...
        def ex():
            sml_arg_1 = int(sml_run_input_1.get())
            sml_arg_2 = int(sml_run_input_2.get())

            if sml_flag_1 == '+':
                sml_run_result = sml_arg_1 + sml_arg_2
            elif sml_flag_1 == '-':
                sml_run_result = sml_arg_1 - sml_arg_2
            elif sml_flag_1 == '*':
                sml_run_result = sml_arg_1 * sml_arg_2
            ...
            sml_run_result_label.configure(text=sml_run_result)

        if sml_code_input.get("1.0", "1.14") != "<!DOCTYPE sml>":
            sml_error_1.configure(text='Ошибка: линия 1')
        else:
            if (sml_code_input.get('2.0', '2.12') != 'using const;') and (sml_code_input.get('2.0', '2.12') != 'using input;'):
                ...
                if sml_code_input.get('2.0', '2.12') == 'using const;':
                        ...
                        if sml_code_input.get('4.0', '4.7') != 'const2=':
                            ...
                            if sml_code_input.get('5.0', '5.7') != 'method=':
                                ...
                                if sml_code_input.get('6.0', '6.4') != 'end;':
                                    ...
                                    sml_run_window.geometry('200x100+50+50')
                                    sml_run_window.resizable(0, 0)

                                    sml_run_arg_1 = Label(sml_run_window, text=sml_arg_1)
                                    sml_run_arg_1.place(x=10, y=30)

                                    sml_run_arg_2 = Label(sml_run_window, text=sml_flag)
                    ...
                    if sml_code_input.get('3.0', '3.7') != 'method=':
                        ...
                        if sml_code_input.get('4.0', '4.4') != 'end;':
                            ...
                            sml_run_arg = Label(sml_run_window, text=sml_flag_1)
    ...
    def sml_Save():
        ...
        sml_save_window.geometry('350x100+80+80')
        sml_save_window.resizable(0, 0)

        sml_save_label = Label(sml_save_window, text='Введите назавание программы...')
    ...
    def sml_Open():
        ...
        sml_open_window.geometry('350x120+80+80')
        sml_open_window.resizable(0, 0)

        sml_open_label = Label(sml_open_window, text='Выберите файл...')
        sml_open_label.place(x=5, y=5)

        sml_open_combobox = ttk.Combobox(sml_open_window, values=os.listdir('C:/MihaSoft Files/SML Files'), font=('Arial Bold', 16), width=20, state='readonly')
    ...
    def sml_Delete():
        ...
        sml_delete_window.geometry('350x120+80+80')
        sml_delete_window.resizable(0, 0)

        sml_delete_label = Label(sml_delete_window, text='Выберите файл...')
        sml_delete_label.place(x=5, y=5)

        sml_delete_combobox = ttk.Combobox(sml_delete_window, values=os.listdir('C:/MihaSoft Files/SML Files'), font=('Arial Bold', 16), width=20, state='readonly')
        ...
        sml_delete_abort_button = Button(sml_delete_window, text='Отмена', bg='#b8b8b8', command=sml_Delete_Abort, width=10)
    ...
    sml_off = Button(window, text='⌂', font=('Arial Bold', 15), width=2, height=1, bg='black', fg='white', command=sml_to_home)
    sml_off.place(x=0, y=0)
...
def TrunsNumSystem():
    ...
    def tns_Begin():
        def lol(to, _from):
            ...
            tns_begin_voc = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'
            tns_begin_res = ''
            while tns_begin_n > 0:
                tns_begin_n, tns_begin_m = divmod(tns_begin_n, to)
                tns_begin_res += tns_begin_voc[tns_begin_m]
            tns_output.insert(1.0, tns_begin_res[::-1])

        if not tns_from_combobox.get().isdigit() or not tns_to_combobox.get().isdigit() or not tns_input.get().isdigit():
            messagebox.showerror('Ошибка!', 'Введены некорректные значения!')
        else:
    ...
    tns_off = Button(window, text='⌂', font=('Arial Bold', 15), width=2, height=1, bg='black', fg='white', command=tns_to_home)
...
def fallout5():
    ...
    cl1 = Button(window, font=('Arial Black', 21), fg='red', bg='#b1d4e6', width=7, height=3, command=x1)
    cl1.place(x=170, y=80)

    cl2 = Button(window, font=('Arial Black', 21), fg='red', bg='#b1d4e6', width=7, height=3, command=x2)
    cl2.place(x=320, y=80)

    cl3 = Button(window,font=('Arial Black', 21), fg='red', bg='#b1d4e6', width=7, height=3, command=x3)
    cl3.place(x=470, y=80)

    cl4 = Button(window, font=('Arial Black', 21), fg='red', bg='#b1d4e6', width=7, height=3, command=x4)
    cl4.place(x=170, y=235)

    cl5 = Button(window, font=('Arial Black', 21), fg='red', bg='#b1d4e6', width=7, height=3, command=x5)
    cl5.place(x=320, y=235)

    cl6 = Button(window, font=('Arial Black', 21), fg='red', bg='#b1d4e6', width=7, height=3, command=x6)
    cl6.place(x=470, y=235)

    cl7 = Button(window, font=('Arial Black', 21), fg='red', bg='#b1d4e6', width=7, height=3, command=x7)
    cl7.place(x=170, y=390)

    cl8 = Button(window, font=('Arial Black', 21), fg='red', bg='#b1d4e6', width=7, height=3, command=x8)
    cl8.place(x=320, y=390)

    cl9 = Button(window, font=('Arial Black', 21), fg='red', bg='#b1d4e6', width=7, height=3, command=x9)
    ...
    lbl2 = Label(window, font=('Times New Roman', 20), fg='blue')
    lbl2.place(x=630, y=140)

    lbl3 = Label(window, font=('Times New Roman', 20), fg='blue')
...
def fallout6():
    ...
    def create():
        def click():
            ...
            bt = Button(win2, text='Сохранить', font=('Arial Bold', 10), bg='#b2e6ae', width=13,
                        command=save)
            bt.place(x=170, y=60)
        ...
        but1 = Button(win1, text='Сохранить', font=('Arial Bold', 12), bg='#b2e6ae', width=13,
                      command=click)
        but1.place(x=15, y=5)
    ...
    def openx():
        ...
        btt1 = Button(window1, text='Открыть', font=('Arial Bold', 10), bg='#7bd491', width=14,
                      command=openz)
    ...
    def edit():
        ...
        btt2 = Button(window1, text='Редактировать', font=('Arial Bold', 10), bg='#79a7c9', width=14,
                      command=openv)
    ...
    btn1 = Button(window1, text='Открыть', font=('Arial Bold', 12), bg='#e6aeae', width=13, command=openx)
    btn1.place(x=210, y=10)
    ToolTip(btn1, 'Открыть файл...')

    btn2 = Button(window1, text='Редактировать', font=('Arial Bold', 12), bg='#aeb4e6', width=13,
                  command=edit)
    btn2.place(x=350, y=10)
    ToolTip(btn2, 'Редактировать существующий файл...')

    btn3 = Button(window1, text='Создать', font=('Arial Bold', 12), bg='#aee6c9', width=13, command=create)
    btn3.place(x=490, y=10)
    ToolTip(btn3, 'Создать новый файл...')

    btn4 = Button(window1, text='Удалить', font=('Arial Bold', 12), bg='#e6e2ae', width=13, command=delet)
    ...
    lin = Label(window1, font=('Arial Bold', 16))
    lin.place(x=50, y=90)

    btt2 = Button(window1, font=('Arial Bold', 10), fg='black', bg='#c97979', width=14)
...
def fallout8():
    ...
    but = Button(window, font=('Arial Bold', 15), width=25, height=2, bg='#98ebc0')
    but.place(x=40, y=80)
...
def fallout10():
    ...
    def vverh_abs():
        ...
        while pushka.winfo_y() != 130 and flag:
    ...
    def vniz_abs():
        ...
        while pushka.winfo_y() != 530 and flag:
            window2.after(speed_push, odin())
            window2.update()
    ...
    pushka = Label(window2, width=10, bg='#ff0000')
    pushka.place(x=30, y=130)

    snaryad = Label(window2, width=2, bg='#11ff00')
    snaryad.place(x=100, y=130)

    cel = Label(window2, width=2, bg='black')
    a = random.randint(130, 530)
    cel.place(x=530, y=a)
...
def TurtlePaint():
    def paint_save():
        ...
        window.state('iconic')
        time.sleep(0.3)
        paint_image = autopy.bitmap.capture_screen()
        time.sleep(0.3)
        window.state('normal')
        paint_window.setup(800, 600)
        paint_file = asksaveasfile(title='Сохранить файл', defaultextension='.png', filetypes=(('PNG file', '*.png'), ('All Files', '*.*')))
        if paint_file:
    ...
    paint_save_button = Button(window, text='СОХРАНИТЬ РИСУНОК', bg='#93e6a8', font=('Arial Bold', 12), command=paint_save)
    paint_save_button.place(x=220, y=170)

    paint_off = Button(window, text='⌂', font=('Arial Bold', 15), width=2, height=1, bg='black', fg='white', command=paint_destroy)
    paint_off.place(x=0, y=0)
    ToolTip(paint_off, 'На главную...')

    TurtleScreen._RUNNING = True

    def paint_switchupdown(x=0, y=0):
        if pen()['pendown']:
            end_fill()
            up()
        else:
...
def valute():
    ...
    valute_window.geometry('330x280+90+90')
    valute_window.resizable(0, 0)
    ...
    valute_exit_button = Button(valute_window, text='ОК', width=16, font=('Times New Roman', 14), bg='#b8b8b8', command=valute_exit)
...
def home():
    ...
    r5 = Button(window, text='TrunsNumSystem', font=('Arial Bold', 13), width=25, height=2, bg='#FFDF00', command=germes4)
    r5.place(x=450, y=780)
    rep(r5)

    r6 = Button(window, text='CrossZero', font=('Arial Bold', 13), width=25, height=2, bg='#FFFFFF', command=germes5)
    r6.place(x=90, y=660)
    rep(r6)

    r7 = Button(window, text='MihNote', font=('Arial Bold', 13), width=25, height=2, bg='#FFFFFF', command=germes6)
    r7.place(x=450, y=660)
    rep(r7)

    r8 = Button(window, text='WindowManager', font=('Arial Bold', 13), width=25, height=2, bg='#93e6a1', command=germes7)
    r8.place(x=90, y=600)
    rep(r8)

    r9 = Button(window, text='HolidayWarnings', font=('Arial Bold', 13), width=25, height=2, bg='#93e6a1', command=germes8)
    r9.place(x=450, y=600)
    rep(r9)

    r10 = Button(window, text='YourWarnings', font=('Arial Bold', 13), width=25, height=2, bg='#9ae3de', command=germes9)
    r10.place(x=90, y=540)
    rep(r10)

    r11 = Button(window, text='Shmalyalka', font=('Arial Bold', 13), width=25, height=2, bg='#9ae3de', command=germes10)
    r11.place(x=450, y=540)
    rep(r11)

    r12 = Button(window, text='Paint', font=('Arial Bold', 13), width=10, height=2, bg='#a9e866', command=germes11)
    r12.place(x=337, y=660)
    rep(r12)

    r13 = Button(window, text='Saper', font=('Arial Bold', 13), width=10, height=2, bg='#d67ab4', command=germes12)
    r13.place(x=337, y=600)
    rep(r13)

    r14 = Button(window, text='TurtlePaint', font=('Arial Bold', 13), width=10, height=2, bg='#9ae3de', command=germes13)
    r14.place(x=337, y=720)
    rep(r14)

    clock_click = Button(window, text='Часы', font=('Arial Bold', 10), width=5, height=1, bg='#b8b8b8', command=Clock)
    clock_click.place(x=10, y=10)
    rep(clock_click)

    settings_click = Button(window, text='Настройки', font=('Arial Bold', 10), width=8, height=1, bg='#b8b8b8', command=Settings)
    settings_click.place(x=70, y=10)
    rep(settings_click)

    message_click = Button(window, text='Сообщение от автора', font=('Arial Bold', 10), width=18, height=1,
                           bg='#b8b8b8', command=AuthorList)
    message_click.place(x=155, y=10)
    rep(message_click)

    valute_click = Button(window, text='Курсы валют', font=('Arial Bold', 10), width=14, height=1,
                           bg='#b8b8b8', command=valute)
    valute_click.place(x=320, y=10)
    rep(valute_click)
