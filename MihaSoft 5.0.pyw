...
def fallout7():
    ...
    def ull():
        global x1, x2, x3, x4, x5, x6, x10, x11
        x1 = str(ent.get())
        x2 = str(ent1.get())
        x3 = str(ent2.get())
        x4 = str(ent3.get())
    ...
    def op():
        def gg():
            global x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, flagx
            flagx = False
            ak = str(ect.get())
    ...
    window.title('WindowManager 1.0')

    lbl = Label(window, text='WindowManager 1.0', font=('Times New Roman', 20), fg='red')
    lbl.place(x=50, y=5)
