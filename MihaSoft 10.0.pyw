...
def Saper():
    ...
    restart_button = Button(window, text='Новая игра', width=10, bg='#93e6a8', font=("Arial Bold", 13),
                            command=RestartGame)
    restart_button.place(x=270, y=10)
