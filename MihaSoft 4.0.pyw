...
def fallout4():
    ...
    def nok():
        a=int(tit.get())
        if a>45:
            messagebox.showinfo('Ошибка!', 'Максимальная для латинского алфавита размерность системы счисления равна 45!')
        lol(a)
    ...
    lbl1.place(x=424, y=90)


    lblx = Label(window, text="", font=("Arial Bold", 15))
    lblx.pack(side=BOTTOM, anchor=CENTER)

    txt = Entry(window, width=40)
    txt.place(x=384, y=110)
    ...
    tet = Button(window, text="Другая система счисления:", fg="red", font=("Arial Bold", 10), bg='#b5ebc2', command=nok)
    tet.place(x=300, y=410)
    tit = Entry(window, width=34)
    tit.place(x=490, y=410)
...
def home():
    ...
    r4.place(x=90, y=720)
    r5 = Button(window, text="TrunsNumSystem 1.0", font=("Arial Bold", 15), width=25, height=2, bg='#ed7474',
                fg="black", command=germes4)
    r5.place(x=400, y=720)
    r6 = Button(window, text="CrossZero 1.0", font=("Arial Bold", 15), width=25, height=2, bg='#d3ed74',
